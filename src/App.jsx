...
const ROLE_KEYWORD_GROUPS = [
  ["店铺运营", /(店铺运营|店务运营|店铺管理|店铺后台|电商运营|淘系运营|快手店铺|抖音店铺|商品运营|店铺店务|商城运营|类目运营|招商运营)/gi],
  ["短视频编导", /(编导|短视频|脚本|选题|内容策划|导演|内容组|分镜|短剧)/gi],
  ["剪辑后期", /(剪辑|后期|剪映|达芬奇|premiere|after effects|包装|调色|混剪)/gi],
  ["拍摄执行", /(拍摄|摄影|机位|打光|收音|器材|布景|出镜)/gi],
  ["信息流投放", /(信息流|投流|投放|优化师|买量|roi|cpm|ctr|cvr|roas|账户|出价|人群包|定向|计划|素材测试|跑量|起量|消耗|千川|磁力金牛|巨量引擎|巨量千川|磁力擎天|阿里妈妈|京准通|超级推荐|引力魔方|万相台|腾讯广告|百度推广|信息流广告)/gi],
  ["直播运营", /(直播运营|中控|场控|直播间|主播|排品|话术|憋单|逼单|福袋|开播|预热|直播投流|憋款|主播培训|带货主播)/gi],
  ["内容运营", /(内容运营|内容增长|新媒体|种草|小红书|公众号|社媒运营|视频号|b站|哔哩哔哩|微博|抖音号|快手号|今日头条|知乎)/gi],
  ["电商平台", /(淘宝|天猫|京东|拼多多|pdd|苏宁|网易严选|有赞|微商城|得物|唯品会)/gi],
  ["跨境电商", /(跨境|amazon|亚马逊|shopee|虾皮|lazada|速卖通|aliexpress|tiktok shop|temu|wish|ebay|独立站|shopify)/gi],
  ["数据分析", /(数据分析|数据运营|数据挖掘|bi报表|tableau|powerbi|帆软|神策|growingio|埋点|看板|经营分析|sql|hive|spark|透视表|vlookup)/gi],
  ["用户增长", /(用户增长|拉新|裂变|留存|召回|aarrr|漏斗|促活|增长黑客|push|短信|私域引流|gmv增长)/gi],
  ["产品运营", /(产品运营|产品经理|prd|需求文档|axure|墨刀|figma|sketch|流程图|原型|迭代|产品方案)/gi],
  ["品牌达人", /(品牌|公关|kol|koc|达人|网红|代言|植入|品宣|曝光|种子用户|达人合作|达人筛选)/gi],
  ["活动大促", /(活动策划|活动运营|大促|618|双11|双12|双十一|双十二|聚划算|秒杀|拼团|满减|优惠券|品类日|超品日|店庆)/gi],
  ["私域社群", /(私域|社群|微信群|企微|企业微信|个微|社群运营|社群管理|crm|scrm|私域运营|裂变群)/gi],
  ["核心指标", /(gmv|arpu|ltv|cac|dau|mau|pv|uv|留存率|转化率|复购率|客单价|gpm|uvr|获客成本|新客占比)/gi],
];
...
export const extractRoleKeywordHits = (text, limit = 30) => {
  const src = String(text || "");
  const hits = [];
