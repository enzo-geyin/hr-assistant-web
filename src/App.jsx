...
const PROVIDERS = {
  ...
  deepseek: {name:"DeepSeek",color:"#4f46e5",logo:"D",endpoint:"https://api.deepseek.com/v1/chat/completions",    keyPlaceholder:"sk-...",           models:[{id:"deepseek-chat",name:"DeepSeek V3.2",note:"非思考模式"},{id:"deepseek-reasoner",name:"DeepSeek R1",note:"深度推理"}],pricing:{"deepseek-chat":{in:0.27,out:1.1},"deepseek-reasoner":{in:0.55,out:2.19}}},
